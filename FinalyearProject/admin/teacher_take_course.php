...
<div class="container" style="padding-top:100px">
	<div class="row">
		...
		<?php
				...
				$sqlone="SELECT dept_name FROM teacher WHERE tname='$keyr'";
				...
				$sql="SELECT course_code,course_title FROM course WHERE dept_name='$resultone'";
		...
		//	$check= mysqli_query($conn,$sql1);
			...
			if(mysqli_num_rows($result)>0){
			   ...
			   $sql2 = "INSERT INTO `teacher_taken`(`teacher name`,`course_code`) VALUES  ('$key2','$key')";
...
<div class="col-md-4">
	...
	<h5 style="color:orange;"><?php echo $_SESSION['teacher name'];?> Sir, Here Is Your Courses </h5>
	<table class="table table-bordered text-center">
		<tr>
			<th>Course Code</th>
