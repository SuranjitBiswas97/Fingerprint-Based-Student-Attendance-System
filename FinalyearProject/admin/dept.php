...
if (isset($_POST["reg_user"])) {
 ...
 if($pass1 ==$pass2){
    ...
    $query = "INSERT INTO `department`(`dept_name`) VALUES  ('$na')";
...
<div class="conatiner size" style="margin-top: 50px;">
  <div class="row">
		<div class="col-md-6 offset-md-3 form-container" style="text-align;" >
			<h3>Department</h3>
			<hr class="red-bar">
			<form action="dept.php" method="POST" >
		
				
				<label for="id"><b>Department</b></label>
				...
				<button "type="submit" name="reg_user" class="signupbtn">Add Department</button>
			</form>
		</div>
