...
<div class="container" style="padding-top:100px">
	<div class="row">
		...
		<?php
				...
				$sql="SELECT course_code,course_title FROM course WHERE course_code NOT IN(SELECT course_code from teacher_taken) AND dept_name=(SELECT dept_name FROM teacher WHERE tname='$keyr')";
...
<div class="col-md-4">
	...
	<?php
				...
				$sqls="SELECT course_code FROM teacher_taken WHERE tname='$keyt'";
